...
This approach was used for glyoxal photolysis in RADM2, which is described by \reactionref{r:GLY_hv_1} and \reactionref{r:GLY_hv_2}.
\begin{reactionlist}
    ...
    \begin{table}
        \begin{center}\small
            \begin{tabular}{lP{4.8cm}P{7.5cm}}
                ...
                \hline \hline
            \end{tabular}
            \caption{Calculation of glyoxal MCM v3.2 photolysis rate parameters retaining RADM2 glyoxyl photolysis product yields.}
...
The resulting \ce{O3} concentration time series were compared and are shown in Figure \ref{f:O3_concentrations}.

\begin{figure}
    \begin{center}
        \includegraphics[width=\textwidth]{img/O3_mixing_ratio_comparison}
        \caption{The time series of the \ce{O3} for the reduced mechanisms using the original and modified approach to \ce{RO2}--\ce{RO2} reactions}
...
Dry deposition velocities are taken from the MCM v3.2. 
